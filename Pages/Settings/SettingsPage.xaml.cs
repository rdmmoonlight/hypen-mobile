...
public partial class SettingsPage : ContentPage
{
    ...
    private async Task UpdateStatusUIAsync(LastFmService service, Label label, Button button, string serviceName, string btnName)
    {
    ...
    private async void OnCheckUpdateManualClicked(object? sender, EventArgs e)
    {
        try 
        { 
            await new UpdateService().CheckAndInstallUpdateAsync("rdmmoonlight", "hypen", isSilent: false); 
        }
        catch 
        { 
